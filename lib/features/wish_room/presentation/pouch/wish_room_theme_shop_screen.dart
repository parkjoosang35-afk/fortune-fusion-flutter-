...
class WishRoomThemeShopScreen extends StatelessWidget {
          ...
          children: [
            Positioned.fill(
              child: Align(
                ...
                child: WishRoomSigil(size: 240, color: palette.sigil, opacity: 0.15),
              ),
            ),
            SafeArea(
              child: Padding(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        WishRoomPouchMonoLabel(text: 'THEME · 소원방 테마', palette: palette),
                    ...
                    Align(
                      ...
                      child: Text('소원방의 하늘\n바꿔 담기', style: WishRoomText.h1(palette.fg).copyWith(fontSize: 22)),
                    ),
                    const SizedBox(height: 14),
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, i) {
                          final t = themes[i];
                          final owned = provider.inventory.themes.contains(t.id);
                          final isCurrent = _themeIdFor(t.id) == provider.theme;
                          final preview = previewPalettes[t.id] ?? WishRoomColors.midnight;
                          return Container(
                            padding: const EdgeInsets.all(10),
                            decoration: BoxDecoration(
                              color: palette.card,
                              border: Border.all(color: isCurrent ? palette.glow : palette.line),
                              ...
                              children: [
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                color: preview.glow,
                                                boxShadow: [BoxShadow(color: preview.glow, blurRadius: 6)],
                                              ),
                                            ),
                                            ...
                                            Container(
                                              width: 10,
                                              height: 10,
                                              decoration: BoxDecoration(shape: BoxShape.circle, color: preview.crystal),
                                            ),
                                          ],
                                        ),
                                      ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(t.name, style: WishRoomText.h3(palette.fg)),
                                ...
                                if (isCurrent)
                                  Container(
                                    ...
                                    child: Text('사용 중', style: WishRoomText.body(palette.glow).copyWith(fontSize: 10, fontWeight: FontWeight.w700)),
                                  )
                                else if (owned)
                                  OutlinedButton(
                                    ...
                                    onPressed: () => provider.setTheme(_themeIdFor(t.id)),
                                    child: Text('바꾸기', style: WishRoomText.body(palette.fg).copyWith(fontSize: 11)),
                                  )
                                else
                                  GestureDetector(
                                    onTap: () => _handleBuy(context, provider, t),
                                    child: Container(
                                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                                      decoration: BoxDecoration(
                                        color: palette.glowShadow,
  ...
  Future<void> _handleBuy(BuildContext context, WishRoomProvider provider, WishRoomCatalogItem t) async {
