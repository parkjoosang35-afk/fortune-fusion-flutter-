                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        onPressed: () => Navigator.of(context).pushNamed('/ai-fortune/face/history'),
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () => Navigator.of(context).pushNamed('/ai-fortune/face/capture'),
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              const Text('종합 관상 해석', style: TextStyle(color: Colors.white70, fontSize: 12)),
        ...
        ...result.features.entries.map((e) => _FeatureTile(part: e.key, text: e.value)),
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              child: Text(part, style: const TextStyle(color: AppColors.primary, fontSize: 11, fontWeight: FontWeight.w700)),
            ),
            const SizedBox(width: AppSpacing.md),
