...
class SajuRepository {
  ...
  static const _branches = ['자', '축', '인', '묘', '진', '사', '오', '미', '신', '유', '술', '해'];
  ...
  Future<ApiResult<SajuResultModel>> requestSaju({
    ...
    String pillar(int offset) => '${_stems[(seed + offset) % 10]}${_branches[(seed + offset * 3) % 12]}';
    ...
    const topicTexts = {
      '재물': '올해는 안정적인 재물운이 이어지며, 특히 하반기에 예상치 못한 수입이 생길 가능성이 있습니다. 무리한 투자보다는 저축과 계획적인 소비가 유리합니다.',
      '애정': '인간관계에서 따뜻한 기운이 감돌며, 솔로라면 새로운 인연을 만날 기회가 열립니다. 커플은 서로에 대한 신뢰가 더욱 깊어지는 시기입니다.',
      '직업': '주변의 인정을 받으며 성장할 수 있는 흐름입니다. 다만 성급한 결정은 피하고, 신중하게 기회를 살펴보는 것이 중요합니다.',
