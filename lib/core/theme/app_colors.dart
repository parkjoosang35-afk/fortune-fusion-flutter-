...
class AppColors {
  ...
  ///
  /// [8가지 버그 리포트 §4 수정] 기존에는 4개 색상뿐이라 1/3/5카드 스프레드마다
  /// TarotResultModel.id를 시드로 뽑아도 4개 중 1개를 고르는 구조상 우연히
  /// 같은 색이 반복되어 나올 확률이 매우 높았다(사용자 리포트: "행운의 색이
  /// 다 똑같이 나온다"). 기존 상수를 재사용해 8개로 확장, 반복 체감을 낮춘다.
