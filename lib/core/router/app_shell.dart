...
/// 다른 4개 탭(운세/커뮤니티/행복머니/마이)의 화면 내부는 아직 다크 우주 톤을
...
class _AppShellState extends State<AppShell> {
  ...
  static const _tabs = [
    ...
    LuckyBagScreen(), // 🍀 행복머니 - 잔액 히어로+커뮤니티엔진 배너+적립방법/사용처/구독보너스/히스토리
  ...
  static const _navItems = [
    ...
    (Icons.card_giftcard_outlined, Icons.card_giftcard_rounded, '행복머니'),
