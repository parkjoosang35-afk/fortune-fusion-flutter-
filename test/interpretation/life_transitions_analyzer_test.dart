...
void main() {
  ...
  test('서로 다른 3명의 A10 결과가 실제로 달라진다', () {
    ...
    for (final input in kJeontongTestInputs) {
      ...
      // ignore: avoid_print
      print(
        '${analysis.transitionPattern} / ${analysis.transitionBondStrength}',
      );
      // ignore: avoid_print
  ...
  test(
    '30명 샘플의 A10 transitionPattern/transitionBondStrength/turningPointsCondition이 계산값에 따라 달라진다',
    () {
