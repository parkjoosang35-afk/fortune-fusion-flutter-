...
export default function AchievementRow({ achievement, canWrite, canDelete }: AchievementRowProps) {
  ...
  return (
    <tr className="border-b border-slate-200/60 hover:bg-slate-100/40">
      <td className="px-4 py-3 font-mono text-slate-700">{achievement.code}</td>
      <td className="px-4 py-3 text-slate-600">{achievement.title}</td>
      <td className="px-4 py-3 text-slate-500">{achievement.conditionType}</td>
      <td className="px-4 py-3 text-slate-500">{achievement.conditionValue}</td>
      <td className="px-4 py-3 text-slate-600">{achievement.rewardPoint.toLocaleString()}P</td>
