...
import { updateLuckybagGrade, type LuckybagFormState } from "@/app/actions/luckybag";

interface LuckybagGradeRowProps {
  grade: {
    id: number;
    code: string;
    name: string;
...
export default function LuckybagGradeRow({ grade, canWrite }: LuckybagGradeRowProps) {
  const [editing, setEditing] = useState(false);
  const [updateState, updateAction, updatePending] = useActionState(updateLuckybagGrade, initialState);
