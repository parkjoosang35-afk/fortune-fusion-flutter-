...
export default function FaqCreateForm({ canWrite }: { canWrite: boolean }) {
  ...
  return (
    ...
    >
      <h3 className="col-span-full text-sm font-semibold text-white">새 FAQ 추가</h3>
      <input
        type="text"
        name="category"
      ...
      <textarea
        ...
        required
        rows={3}
        className="rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-white outline-none focus:border-indigo-500 md:col-span-4"
      />
