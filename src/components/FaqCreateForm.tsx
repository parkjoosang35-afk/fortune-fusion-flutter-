...
import { createFaq, type FaqFormState } from "@/app/actions/faqs";

const initialState: FaqFormState = {};

export default function FaqCreateForm({ canWrite }: { canWrite: boolean }) {
  ...
  return (
    ...
    >
      <h3 className="col-span-full text-sm font-semibold text-slate-900">새 FAQ 추가</h3>
      <input
        type="text"
        name="category"
        placeholder="카테고리 (예: 결제/구독)"
        required
