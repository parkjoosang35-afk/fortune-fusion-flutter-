...
export default function SubscriptionPlanCreateForm({ canWrite }: SubscriptionPlanCreateFormProps) {
  ...
  return (
    ...
    >
      <h3 className="col-span-full text-sm font-semibold text-slate-900">새 구독 플랜 추가</h3>
      <input
        type="text"
        name="name"
        placeholder="플랜명"
      ...
      <textarea
        ...
        required
        rows={3}
        className="rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-indigo-500 md:col-span-3"
      />
