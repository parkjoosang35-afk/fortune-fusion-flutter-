...
export default function PassPolicyCreateForm({ canWrite }: { canWrite: boolean }) {
  ...
  return (
    ...
    >
      <h2 className="col-span-full text-sm font-semibold text-white">새 프리패스 상품 추가</h2>
      <input
        type="text"
        name="name"
      ...
      <hr className="col-span-full border-slate-800" />
      <p className="col-span-full text-xs font-medium text-slate-400">§3 프리패스 운영 확장 필드</p>
