...
export default function OpenPassAdSourceCreateForm({
  ...
  return (
    ...
    >
      <h2 className="col-span-full text-sm font-semibold text-white">새 광고소스 등록</h2>
      ...
      <p className="col-span-full text-xs text-slate-500">
        타입을 <b className="text-slate-300">[테스트]</b>로 시작하는 항목(mock_rewarded_*)을 선택하면 실제 광고 SDK
