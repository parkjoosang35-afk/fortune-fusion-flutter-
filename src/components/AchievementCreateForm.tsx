...
export default function AchievementCreateForm({ canWrite }: { canWrite: boolean }) {
  ...
  return (
    <form
      ...
      className="mb-6 grid grid-cols-1 gap-3 rounded-xl border border-slate-800 bg-slate-900 p-4 md:grid-cols-3"
    >
      <h3 className="col-span-full text-sm font-semibold text-white">새 업적 추가</h3>
      <input
        type="text"
        name="code"
