...
export default async function NotificationHistoryPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-900">알림 관리 — 발송 이력 조회</h1>
      ...
      <div className="overflow-x-auto rounded-xl border border-slate-200 bg-white">
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            ...
            {sorted.map((n) => (
              <tr key={n.id} className="border-b border-slate-200/60 hover:bg-slate-100/40">
                <td className="px-4 py-3 text-slate-600">{n.user.nickname}</td>
