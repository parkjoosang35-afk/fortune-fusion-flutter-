...
export default async function AdminRolesPermissionsPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white">운영/보안 — 역할/권한 매트릭스</h1>
      ...
      <div className="mb-4 rounded-lg border border-amber-800 bg-amber-950/40 px-4 py-3 text-xs text-amber-300">
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            {menuCodes.map((menuCode) => {
              ...
              return (
                <tr key={menuCode} className="border-b border-slate-800/60 hover:bg-slate-800/40">
                  <td className="px-4 py-2 text-slate-200">{menuLabel}</td>
                  {roles.map((r) => {
